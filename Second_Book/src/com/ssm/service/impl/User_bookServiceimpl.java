...
public class User_bookServiceimpl implements User_bookService {
	...
	/* (non-Javadoc)
	 * @see com.ssm.service.User_bookService#CancelAduit(com.ssm.pojo.User_book)
	 */
	@Override
	public void CancelAduit(User_book user_book) {
		// TODO Auto-generated method stub
		user_bookMapper.CancelAduit(user_book);
	}
