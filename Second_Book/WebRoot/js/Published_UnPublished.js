	/**我的书籍，已发布链接 不在售卖 功能按钮**/
function Unpublish(Book_Bid,User_Uid,start){
		var start=0;
		var startN;
		if(Number(start)==0){
			startN=6;
...
/*					"<span class='AduitDataSpan'>书籍描述:</span>"+
				...
				"' class='btn btn-primary' " +
				"onclick='return Unpublish("+value.book_Bid+","+value.user_Uid +")'>不在售卖</a>" +
				"<p><p>" +
				"<a href='javascript:void(0)' class='btn btn-primary'" +
				" onclick='del(this,"+value.book_Bid+","+value.user_Uid+","+start+")'>修改信息</a><p>" +
				"</div>" +
